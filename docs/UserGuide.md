...
Examples:
*  `edit 1 p/91234567 e/johndoe@example.com` Edits the phone number and email address of the 1st book to be `91234567` and `johndoe@example.com` respectively.
*  `edit 2 n/Betsy Crower t/` Edits the name of the 2nd book to be `Betsy Crower` and clears all existing tags.
...
Examples:
* `list` followed by `delete 2` deletes the 2nd book in the address book.
