...
public class AddNoteCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        // invalid title
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + NOTE_TEXT,
                Note.MESSAGE_CONSTRAINTS);

        // invalid text
        assertParseFailure(parser, "1" + NAME_DESC_JANE_EYRE + INVALID_NOTE_TEXT, Note.MESSAGE_CONSTRAINTS);

        // no index specified
        assertParseFailure(parser, NAME_DESC_JANE_EYRE + NOTE_TEXT,
